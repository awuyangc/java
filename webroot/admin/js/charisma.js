$(document).ready(function () {
    ...
    $('#is-ajax').prop('checked', $.cookie('is-ajax') === 'true' ? true : true);
	...
	*/
    ...
    $('a.ajax-link').click(function (e) {
        ...
        if (e.which != 1 || !$('#is-ajax').prop('checked') || $(this).parent().hasClass('active')) return false;
        e.preventDefault();
        $('.sidebar-nav').removeClass('active');
        $('.navbar-toggle').removeClass('active');
        $('#loading').remove();
        //$('#content').parent().append('<div id="loading" class="center">页面加载中...<div class="center"></div></div>');
        var $clink = $(this);
        //暂停使用histoty插件
